...
internal struct SHFILEINFO {
    ...
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Constant.MAX_PATH)]
    public string szDisplayName;
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Constant.MAX_TYPE)]
...
internal static class PInvoke {
    ...
    public static ImageSource GetIcon(string strPath, bool bSmall, bool isFile) {
        ...
        int dwFileAttributes;
        if (isFile) {
            dwFileAttributes = Constant.FILE_ATTRIBUTE_NORMAL;
        } else {
            dwFileAttributes = Constant.FILE_ATTRIBUTE_DIRECTORY;
        }
        _ = SHGetFileInfo(strPath, dwFileAttributes, out info, (uint)cbFileInfo, flags);
